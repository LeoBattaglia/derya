...
const properties = require("../backup/css/properties.json");
//Class
class HTMLElement {
    //Constructor
    ...
    addAttributeOnafterprint(value) {
        this.addAttribute("onafterprint", value);
    }
    addAttributeOnbeforeprint(value) {
        this.addAttribute("onbeforeprint", value);
    }
    addAttributeOnbeforeunload(value) {
        this.addAttribute("onbeforeunload", value);
    }
    addAttributeOnerror(value) {
        this.addAttribute("onerror", value);
    }
    addAttributeOnhashchange(value) {
        this.addAttribute("onhashchange", value);
    }
    addAttributeOnload(value) {
        this.addAttribute("onload", value);
    }
    addAttributeOnmessage(value) {
        this.addAttribute("onmessage", value);
    }
    addAttributeOnoffline(value) {
        this.addAttribute("onoffline", value);
    }
    addAttributeOnonline(value) {
        this.addAttribute("ononline", value);
    }
    addAttributeOnpagehide(value) {
        this.addAttribute("onpagehide", value);
    }
    addAttributeOnpageshow(value) {
        this.addAttribute("onpageshow", value);
    }
    addAttributeOnpopstate(value) {
        this.addAttribute("onpopstate", value);
    }
    addAttributeOnresize(value) {
        this.addAttribute("onresize", value);
    }
    addAttributeOnstorage(value) {
        this.addAttribute("onstorage", value);
    }
    addAttributeOnunload(value) {
        this.addAttribute("onunload", value);
    }
    addAttributeOnblur(value) {
        this.addAttribute("onblur", value);
    }
    addAttributeOnchange(value) {
        this.addAttribute("onchange", value);
    }
    addAttributeOncontextmenu(value) {
        this.addAttribute("oncontextmenu", value);
    }
    addAttributeOnfocus(value) {
        this.addAttribute("onfocus", value);
    }
    addAttributeOninput(value) {
        this.addAttribute("oninput", value);
    }
    addAttributeOninvalid(value) {
        this.addAttribute("oninvalid", value);
    }
    addAttributeOnreset(value) {
        this.addAttribute("onreset", value);
    }
    addAttributeOnsearch(value) {
        this.addAttribute("onsearch", value);
    }
    addAttributeOnselect(value) {
        this.addAttribute("onselect", value);
    }
    addAttributeOnsubmit(value) {
        this.addAttribute("onsubmit", value);
    }
    addAttributeOnkeydown(value) {
        this.addAttribute("onkeydown", value);
    }
    addAttributeOnkeypress(value) {
        this.addAttribute("onkeypress", value);
    }
    addAttributeOnkeyup(value) {
        this.addAttribute("onkeyup", value);
    }
    addAttributeOnclick(value) {
        this.addAttribute("onclick", value);
    }
    addAttributeOndblclick(value) {
        this.addAttribute("ondblclick", value);
    }
    addAttributeOnmousedown(value) {
        this.addAttribute("onmousedown", value);
    }
    addAttributeOnmousemove(value) {
        this.addAttribute("onmousemove", value);
    }
    addAttributeOnmouseout(value) {
        this.addAttribute("onmouseout", value);
    }
    addAttributeOnmouseover(value) {
        this.addAttribute("onmouseover", value);
    }
    addAttributeOnmouseup(value) {
        this.addAttribute("onmouseup", value);
    }
    addAttributeOnmousewheel(value) {
        this.addAttribute("onmousewheel", value);
    }
    addAttributeOnwheel(value) {
        this.addAttribute("onwheel", value);
    }
    addAttributeOndrag(value) {
        this.addAttribute("ondrag", value);
    }
    addAttributeOndragend(value) {
        this.addAttribute("ondragend", value);
    }
    addAttributeOndragenter(value) {
        this.addAttribute("ondragenter", value);
    }
    addAttributeOndragleave(value) {
        this.addAttribute("ondragleave", value);
    }
    addAttributeOndragover(value) {
        this.addAttribute("ondragover", value);
    }
    addAttributeOndragstart(value) {
        this.addAttribute("ondragstart", value);
    }
    addAttributeOndrop(value) {
        this.addAttribute("ondrop", value);
    }
    addAttributeOnscroll(value) {
        this.addAttribute("onscroll", value);
    }
    addAttributeOncopy(value) {
        this.addAttribute("oncopy", value);
    }
    addAttributeOncut(value) {
        this.addAttribute("oncut", value);
    }
    addAttributeOnpaste(value) {
        this.addAttribute("onpaste", value);
    }
    addAttributeOnabort(value) {
        this.addAttribute("onabort", value);
    }
    addAttributeOncanplay(value) {
        this.addAttribute("oncanplay", value);
    }
    addAttributeOncanplaythrough(value) {
        this.addAttribute("oncanplaythrough", value);
    }
    addAttributeOncuechange(value) {
        this.addAttribute("oncuechange", value);
    }
    addAttributeOndurationchange(value) {
        this.addAttribute("ondurationchange", value);
    }
    addAttributeOnemptied(value) {
        this.addAttribute("onemptied", value);
    }
    addAttributeOnended(value) {
        this.addAttribute("onended", value);
    }
    addAttributeOnloadeddata(value) {
        this.addAttribute("onloadeddata", value);
    }
    addAttributeOnloadedmetadata(value) {
        this.addAttribute("onloadedmetadata", value);
    }
    addAttributeOnloadstart(value) {
        this.addAttribute("onloadstart", value);
    }
    addAttributeOnpause(value) {
        this.addAttribute("onpause", value);
    }
    addAttributeOnplay(value) {
        this.addAttribute("onplay", value);
    }
    addAttributeOnplaying(value) {
        this.addAttribute("onplaying", value);
    }
    addAttributeOnprogress(value) {
        this.addAttribute("onprogress", value);
    }
    addAttributeOnratechange(value) {
        this.addAttribute("onratechange", value);
    }
    addAttributeOnseeked(value) {
        this.addAttribute("onseeked", value);
    }
    addAttributeOnseeking(value) {
        this.addAttribute("onseeking", value);
    }
    addAttributeOnstalled(value) {
        this.addAttribute("onstalled", value);
    }
    addAttributeOnsuspend(value) {
        this.addAttribute("onsuspend", value);
    }
    addAttributeOntimeupdate(value) {
        this.addAttribute("ontimeupdate", value);
    }
    addAttributeOnvolumechange(value) {
        this.addAttribute("onvolumechange", value);
    }
    addAttributeOnwaiting(value) {
        this.addAttribute("onwaiting", value);
    }
    addAttributeOntoggle(value) {
        this.addAttribute("ontoggle", value);
    }
    ...
    addStyleImageRendering(value) {
        if (this.validateStyleValue("image-rendering", value)) {
            this.addStyle("image-rendering", value);
        }
    }
    ...
    addStyleOverflowWrap(value) {
        if (this.validateStyleValue("overflow-wrap", value)) {
            this.addStyle("overflow-wrap", value);
        }
    }
